...
class ReportService {
  ...
  static HazardSubcategoryData _mapSubcategoryData(dynamic s) {
    ...
    return HazardSubcategoryData(
      ...
      categoryId: sm['category_id']?.toString() ?? sm['category']?['id']?.toString(),
  ...
  static Future<HazardSubcategoryData?> updateSubcategory(String categoryId, String subId, String name, {String? abbreviation, String? description, bool? isActive}) async {
