...
final List<Report> dummyReports = [
  ...
  Report(
    ...
    saran:
        'Rapikan dan simpan peralatan sesuai rak yang tersedia. Pasang label dan marking area penyimpanan.',
  ...
  Report(
    ...
    saran:
        'Isolasi segera kabel yang terkelupas dengan isolator listrik. Panggil teknisi untuk penanganan permanen.',
    perusahaan: 'PT. Bukit Baiduri Energi',
  ...
  Report(
    ...
    saran:
        'Buka kunci pintu darurat segera. Pasang peringatan larangan mengunci pintu darurat dan lakukan audit akses.',
    perusahaan: 'PT. Bukit Baiduri Energi',
    departemen: 'Security',
    tagOrang: 'Eko Susilo',
  ...
  Report(
    ...
    saran:
        'Tegur operator dan wajibkan penggunaan harness. Laksanakan toolbox meeting mengenai keselamatan bekerja di ketinggian.',
    perusahaan: 'PT. Khotai Makmur Insan Abadi',
    departemen: 'Produksi',
